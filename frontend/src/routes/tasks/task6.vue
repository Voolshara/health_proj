<template>
  <div class="container-form">
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <p style="text-align: left; width: 30vw">
          Первоначальное положение обеих сторон - руки выпрямлены в локте и
          опущены вниз
        </p></el-col
      >
      <el-col :span="11">
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>
            ...
            ладонью запястье с внутренней стороны Сопротивление ассистента -
            1≈2/5
          </p>
      ...
      <el-col :span="11">
        <div style="display: flex">
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/body_l.jpg"
            :fit="fit"
          />
          <div style="width: 30px"></div>
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/body_r.jpg"
            :fit="fit"
          />
        </div>
      </el-col>
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>
            Конечное положение обеих сторон - согнутая рука внутренней стороной
            к себе
          </p>
        </div></el-col
      >
      <el-col :span="11">
        <div style="display: flex">
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/body_l_2.jpg"
            :fit="fit"
          />
          <div style="width: 30px"></div>
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/body_r_2.jpg"
            :fit="fit"
          />
        </div>
      </el-col>
    ...
    <el-row style="margin-top: 50px">
      <el-col :span="15">Правая сторона</el-col>
    ...
    <el-row style="margin-top: 30px">
      <el-col :span="15">
        <video width="300" height="300" controls>
          <source src="/img/task1/body_l.mp4" type="video/mp4" /></video
      ></el-col>
      <el-col :span="3"
        ><video width="300" height="300" controls>
          <source src="/img/task1/body_r.mp4" type="video/mp4" />
        </video>
      </el-col>
    </el-row>

    <BottomSlider :task_num="'task6'" />
  </div>
</template>
