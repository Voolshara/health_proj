<template>
  <div class="container-form">
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <p style="text-align: left; width: 30vw">
          Первоначальное положение обеих сторон - слегка вытянутые ноги
        </p></el-col
      >
      <el-col :span="11">
        <el-image
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>
            ...
            на конец носка Сопротивление ассистента - 0≈1/5
          </p>
      ...
      <el-col :span="11">
        <div style="display: flex">
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/leg_l.jpg"
            :fit="fit"
          />
          <div style="width: 30px"></div>
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/leg_r.jpg"
            :fit="fit"
          />
        </div>
      </el-col>
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>Конечное положение обеих сторон - поднятие носка пациента</p>
        </div></el-col
      >
      <el-col :span="11">
        <div style="display: flex">
    ...
    <el-row style="margin-top: 50px">
      <el-col :span="15">Правая нога</el-col>
      <el-col :span="4">Левая нога</el-col>
    </el-row>

    <el-row style="margin-top: 30px">
      <el-col :span="15">
        <video width="300" height="300" controls>
          <source src="/img/task1/leg_l_v.mp4" type="video/mp4" /></video
      ></el-col>
      <el-col :span="3"
        ><video width="300" height="300" controls>
          <source src="/img/task1/leg_r_v.mp4" type="video/mp4" />
        </video>
      </el-col>
    </el-row>
