  ...
  <div class="container-form">
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>
            Место проверки для обеих сторон от лица ассистента - обхватить ребро
            наружной стороны стопы Сопротивление ассистента - 0/5 (просто
            приложить)
          </p>
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>
            Конечное положение обеих сторон - поворот стопы в наружную сторону
            без поворота ноги
          </p>
        </div></el-col
      >
    ...
    <el-row style="margin-top: 30px">
      <el-col :span="15">
        <video width="300" height="300" controls>
          <source src="/img/task1/p_leg_1.mp4" type="video/mp4" /></video
      ></el-col>
      <el-col :span="3"
        ><video width="300" height="300" controls>
          <source src="/img/task1/p_leg_2.mp4" type="video/mp4" />
        </video>
      </el-col>
    </el-row>

    <BottomSlider :task_num="'task3'" />
  </div>
</template>
