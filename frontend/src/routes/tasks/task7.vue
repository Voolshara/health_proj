<template>
  <div class="container-form">
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <p style="text-align: left; width: 30vw">
          Первоначальное положение обеих сторон - кисти развернуты и опущены
          вниз
        </p></el-col
      >
      <el-col :span="11">
      ...
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>
            ...
            ладонью боковую часть запястья Сопротивление ассистента - 1/5
          </p>
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>Конечное положение обеих сторон - согнутая рука ребром к плечу</p>
        </div></el-col
      >
      <el-col :span="11">
        <div style="display: flex">
