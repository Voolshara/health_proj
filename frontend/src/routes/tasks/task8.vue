<template>
  <div class="container-form">
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <p style="text-align: left; width: 30vw">
          Первоначальное положение обеих сторон - руки развернуты и согнуты к
          плечу
        </p></el-col
      >
      <el-col :span="11">
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>
            Место проверки для обеих сторон от лица ассистента - обхватить
            боковую стороны запястья Сопротивление ассистента - 1≈2/5
          </p>
      ...
      <el-col :span="11">
        <div style="display: flex">
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/top_body_3.jpg"
            :fit="fit"
          />
          <div style="width: 30px"></div>
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/top_body_3.2.jpg"
            :fit="fit"
          />
        </div>
      </el-col>
    ...
    <el-row class="task-container">
      <el-col :span="13">
        <div style="text-align: left; width: 30vw">
          <p>Конечное положение обеих сторон - разогнутая рука ребром вниз</p>
        </div></el-col
      >
      <el-col :span="11">
        <div style="display: flex">
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/top_body_4.jpg"
            :fit="fit"
          />
          <div style="width: 30px"></div>
          <el-image
            style="width: 200px; height: 200px"
            src="/img/task1/top_body_4.2.jpg"
            :fit="fit"
          />
        </div>
      </el-col>
    ...
    <el-row style="margin-top: 50px">
      <el-col :span="15">Права сторона</el-col>
      <el-col :span="4">Левая сторона</el-col>
    </el-row>

    <el-row style="margin-top: 30px">
      <el-col :span="15">
        <video width="300" height="300" controls>
          <source src="/img/task1/body_top_1.mp4" type="video/mp4" /></video
      ></el-col>
      <el-col :span="3"
        ><video width="300" height="300" controls>
          <source src="/img/task1/body_top_2.mp4" type="video/mp4" />
        </video>
      </el-col>
    </el-row>

    <BottomSlider :task_num="'task8'" />
  </div>
</template>
